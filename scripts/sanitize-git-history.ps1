...
#   - Referência do projeto Supabase (xvcrfouolhnjkxvcxmda)
#
...
@(
    "literal:mariahilmar@gmail.com==>seu-email@org.gov.br"
    "literal:anne.knoll@gestao.gov.br==>outro-email@org.gov.br"
    "literal:https://xvcrfouolhnjkxvcxmda.supabase.co==>https://xxx.supabase.co"
    "literal:xvcrfouolhnjkxvcxmda==>YOUR_PROJECT_REF"
    "literal:# Supabase — MGI Dashboard (projeto YOUR_PROJECT_REF)==># Supabase — configure com a URL do seu projeto"
