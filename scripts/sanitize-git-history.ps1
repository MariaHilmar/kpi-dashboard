...
#   - referências D:\mgi-workspace em arquivos que permanecem
...
function New-ReplacementsFile {
    ...
    @(
        "literal:D:\\mgi-workspace==>seu-workspace"
        "literal:D:/mgi-workspace==>seu-workspace"
...
Test-HistoryClean "caminho local Windows" "git log -p --all -S D:\\mgi-workspace"
