...
export function KpiGrid({ kpis }: KpiGridProps) {
  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
      <KpiCard label="Total filtrado" value={formatNumber(kpis.total)} accent="info" />
      <KpiCard label="Fechadas" value={formatNumber(kpis.fechadas)} accent="success" />
      <KpiCard label="Abertas" value={formatNumber(kpis.abertas)} accent="warning" />
      ...
      <KpiCard label="Bugs abertos" value={formatNumber(kpis.bugs_abertos)} accent="danger" />
      <KpiCard label="Melhorias abertas" value={formatNumber(kpis.melhorias_abertas)} />
