...
export function FluxoLeadTimeDistribuicaoCard({
  ...
  const countLabel =
    ...
    summary && summary.count > 0 ? (
      ...
      <IssueCountLink
        ...
        href={closedIssuesHref}

        label="issues fechadas no período"
  ...
  return (
    ...
    <section
      ...
      className="overflow-visible rounded-xl border border-slate-200 bg-white p-5 shadow-sm"
    ...
    >
      ...
      <CardSectionHeader
        ...
        subtitle={
          ...
          summary ? (
            ...
            <>
              ...
              {countLabel} issues fechadas no período
        ...
        tooltip={FLUXO_SECTION_TOOLTIPS.leadTimeDistribuicao}
