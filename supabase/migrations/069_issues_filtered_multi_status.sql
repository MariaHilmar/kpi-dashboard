-- =============================================================================
-- Migration 069 — Filtro de Status com multiplos valores
--
-- `p_status` passa a aceitar uma lista separada por virgula (ex.: "Doing,Backlog").
-- Retrocompatível: um unico valor ("Doing") e "Todos"/NULL continuam funcionando.
-- Atualiza `_issues_filtered` (KPIs/gráficos) e `search_issues` (listagem).
-- =============================================================================
