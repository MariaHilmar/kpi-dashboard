-- =============================================================================
-- Migration 060 — search_issues: filtro por data de merge (drill-down mergeadas)
-- =============================================================================
...
comment on function public.search_issues(
  ...
  'Lista paginada de issues com filtros globais, merge/fechamento e campos Planning Poker.';
