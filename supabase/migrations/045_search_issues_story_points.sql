-- =============================================================================
-- Migration 045 — search_issues: campos Planning Poker + ordenação por story_points
-- =============================================================================
...
comment on function public.search_issues(
  ...
  'Lista paginada de issues com filtros globais, campos Planning Poker e ordenação por story_points.';
